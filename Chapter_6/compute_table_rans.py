from aux.entropy_coordinate_hyperball import compute_f_table
from math import floor, ceil, log

param = [#deg,k, l,     B, a,  n, sec
        (256, 2, 4,  9775, 8, 16, 120), # 120 params
        (256, 3, 6, 15705, 8, 16, 180), # 180 params
        (256, 4, 7, 20610, 8, 16, 260)  # 260 params
        ]
...
for (deg, k, l, B, a, n, sec) in param:
    ...
    #Finally, we measure the discrepancy between the rounded distribution and the one we computed in order to estimate the encoding losse per coordinate.
